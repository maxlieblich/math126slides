...
(function() {
  var DIRNUM, mathmodels, oid, oidmap, oidslice, preImplant, rainier, rotateAroundObjectAxis, startmodels;
  ...
  rainier.embed(DIRNUM + "/rainier.js", new THREE.MeshNormalMaterial({
    color: 0xb88a00,
    opacity: 0.5,
    transparent: true
  }), true);
  ...
  oid.embed(DIRNUM + "/oid.js", new THREE.MeshNormalMaterial({
    color: 0xb88a00,
    opacity: 0.5,
    transparent: true
  }), true);
  ...
  oidslice.embed(DIRNUM + "/oidslice.js", new THREE.MeshNormalMaterial({
    color: 0xb88a00,
    opacity: 0.5,
    transparent: true
  }), true);
