...
(function() {
  var i, mathmodels, newneworigin, neworigin, origin, startmodels, vector1, vectorcolor, vectors1, vectors2, vectors3, vectors4, vectors5, vectors6, vectors7, vectors8, _i, _j, _k, _l, _m, _n;
  ...
  startmodels = function() {
    var model, _len, _o;
    for (_o = 0, _len = mathmodels.length; _o < _len; _o++) {
      model = mathmodels[_o];
      model.go();
    }
    return null;
