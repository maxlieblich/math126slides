    ...
    /* Methods exposed in the jQuery.deck namespace */
        methods = {
            ...
            init: function(elements, opts) {
                ...
                // Ignore instructions slide; being treated as slide to hide/reveal instead of modal for now
                if ($.isArray(elements)) {
                    $.each(elements, function(i, e) {
                        if (e != document.getElementById("instructions"))
                            slides.push($(e));
                    });
                }
                else {
            ...
            /*
             ...
             Moves to the next slide. Try to find next lecture chunk using built in button.
             If this fails, loop back to the beginning.
             */
            next: function() {
                if (current < slides.length - 1)
                    ...
                    try {
                        ...
                        methods.go((current+1) % slides.length);
                    }
                }
            },
            ...
            /*
             ...
             call is ignored. For now, don't loop all the way around, since going forward
             at end loads next lecture and this makes a mess
             */
            prev: function() {
                if (current === 1){
                    try {
